...
<br/>        
 <form method="post" action="" >   
        <table>                                    
            ...
            <tr>
                <td></td>
                <td><input style="width:200px" type='submit' value='Update Account' name='but_upload'></td>
            </tr>
      ...
      <div class="hold">             
                    <table >
                        ...
                        <tr style=" text-align: center;background-color: whitesmoke;border:1px solid lightgray">
                            ...
                            <td style="width:67px;background-color: whitesmoke;text-align: center;height:35px">ADMIN</td>
                ...
                if($result -> num_rows > 0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        <td>" . $row['password'] . "</td>
                         ...
                         <td><a onclick='valid()' href=' '><button name='id' type='button' data-toggle='modal' data-target='#exampleModalCenter' class='btn btn-primary'>ADMIN</button></td></a>
                            </tr>";
    }                
}             
                ?>       
