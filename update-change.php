 ...
 <form method="post" action="" enctype='multipart/form-data'>   
    ...
    ?>
                        ...
                        <tr>
                            ...
                            <td><input name="fac" id="name" value="<?php echo $_REQUEST['name']?>"/></td>
                ...
                <tr>
                      <td><p>SUBJECT / SECTION: </p></td> 
                            <td><input name="subject" id="subject" value="<?php echo $_REQUEST['subject']?>"/></td>                 
                </tr>
            
            <tr>
                      <td><p> DEPARTMENT: </p></td> 
                              <td><input name="dept" id="dept" value="<?php echo $_REQUEST['dept']?>"/></td>
            </tr>
                     <tr>
                            <td><p>DATE: </p></td>
                            <td><input name="date" id="date" value="<?php echo $_REQUEST['date']?>"/></td>
                ...
                <tr>
                               <td><p>TIME / DAY: </p></td>
                            <td><input name="time" id="time" value="<?php echo $_REQUEST['time']?>"/></td>
                                 
                 </tr>
                    <tr>
                            
                              <td><p>ROOM: </p></td> 
                              <td><input name="room" id="room" value="<?php echo $_REQUEST['room']?>"/></td>
                    </tr> 
                <tr>
            ...
            <tr>
                <td></td>
                <td><input style="width:200px" type='submit' value='Save' name='but_upload' class="btn btn-primary"></td>
            </tr>
...
?>
            <div class="prof">
                <div class="profCover">               
                    <img src="images/<?php echo $_REQUEST['images']?>" style="height: 300px;width: 300px;margin-left: 0px;border-radius: 5px;margin-top: -410px"  >                 
                </div>                                        
                </form>                   
                    </div>
        <br/>
