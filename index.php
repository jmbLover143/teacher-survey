...
<body class=" ">
    ...
    <img class="cover" src="images/Capture_1.PNG">
            <div class="prof">
                <button  type="button" data-toggle="modal" data-target="#exampleModalCenter" style="margin-top:-600px;width:210px;margin-left: -125px" class="btn btn-warning">START NOW</button>
                        </div>
        <br/>
        <br/> 
