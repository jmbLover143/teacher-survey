...
<body class=" ">
    ...
    <div class="side">       
        ...
        <div class="container">               
                ...
                <form action="fac-search.php" method="POST" >
                    <p><input type="submit" style="float:right;margin-top: -30px"> <input name="name" id=""  style="float:right;font-size: 18px;margin-top: -30px;margin-right: 60px;" placeholder="Search name .."></p>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width:50px;text-align: center;background-color: whitesmoke;">ACTION</td>                           
                             ...
                             <?php
                include ("dbconfig.php");                
                $query = "Select id,images,name,subject,dept,date,time,room From teacher";
