    ...
    <div class="side">       
        ...
        <div class="container">               
                ...
                <?php 
                    ...
                    $sql = "Select id,name,images from teacher";
                    $result = mysqli_query($conn, $sql); 
                    if($result -> num_rows > 0){
                        while($row = $result -> fetch_assoc()){
                            echo " \t
                           <a href='results-view.php?id=$row[id]'><img class='zoom' style='height:200px;width:200px;border:1px solid black;border-radius:5px;' src='images/".$row['images']."' /></a>\t                           
";           
                    }
                    }                
                ?>                    
